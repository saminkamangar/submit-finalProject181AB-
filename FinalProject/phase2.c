...
void mult1(int fignum, int dim1, int dim2, int dim3)
{
	int i, j, k;
	float sum = 0;
...
void newmult2(int offset1, int offset2, int dim1, int dim2, int dim3)
{
	int i, j, k;
	float sum = 0;
...
void mult3(int offset1, int offset2, int dim1, int dim2, int dim3)
{
	int i, j, k;
	float sum = 0;
...
void add(int offset1, int offset2, int dim1, int dim2)
{
	int i, j;
	for (i = 0; i < dim1; i++) {
		for (j = 0; j < dim2; j++) {
			((float*)sdram)[offset1+i*dim2+j] += ((float*)sdram)[offset2+i];
		}
	}
}
